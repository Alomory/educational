...
public class NumberGetter implements NumberGetterInterface {
    private String onError;
    private Function<Number, Boolean> rules;
    private boolean persistent;

    // Constructors
    public NumberGetter(boolean persistent) {
    ...
    public NumberGetter(String onError, Function<Number, Boolean> rules) {
        this.onError = onError;
        this.rules = rules;
    }

    public NumberGetter(String onError, Function<Number, Boolean> rules, boolean persistent) {
        this(onError, rules);
        this.persistent = persistent;
    }
    ...
    public static Number scan(String question, String onError, Function<Number, Boolean> rules) {
        Scanner s = new Scanner(System.in);
        try {
            NumberGetterInterface ng = new NumberGetterInterface() {
                public String getString(String question) {
                    System.out.print(question);
                    return s.nextLine();
                }
