...
public class Module3 {
    public static void activity1() {
        int wage = GetNumber.scanInt("Wage (per hour)? ");
        int hour = GetNumber.scanInt("Working time (in hours)? ");
        int gross = hour * wage;
    ...
    public static void activity2() {
        ...
        System.out.println("*****************************************************");
        int callTime = GetNumber.scanInt("ENTER THE NUMBER OF EXCESS MINUTES: ");
    ...
    public static void activity3() {
        double Celsius = (double) GetNumber.jopDouble("Temperature in Celsius?", "Activity3");
    ...
    public static void activity5() {
        double weight = GetNumber.jopDouble("Your weight? (in kg) ", "Activity 5");
        double height = GetNumber.jopDouble("Your height? (in m) ", "Activity 5");
    ...
    public static void activity6() {
        double price = GetNumber.jopDouble("Product price? (in RM)", "Activity 6");
